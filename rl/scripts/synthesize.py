...
class SyntheticMetricsGenerator:
    ...
    def __init__(
        ...
        self.phase_schedule = {
            ...
            "N100": {"C": [0.06, 0.09, 0.11, 0.12, 0.12, 0.11, 0.10, 0.09, 0.09, 0.05],
                     "RC": [0.07, 0.11, 0.12, 0.11, 0.10, 0.10, 0.10, 0.09, 0.09, 0.05],
                     "R": [0.09, 0.13, 0.12, 0.10, 0.09, 0.09, 0.09, 0.09, 0.09, 0.10]},
        ...
        self.phase_decay_rates = {
            ...
            "N100": {"C": [1.4, 3.2, 2.8, 2.3, 1.9, 1.6, 1.3, 1.0, 0.7, 0.4],
                     "RC": [1.2, 2.8, 2.5, 2.0, 1.6, 1.4, 1.1, 0.8, 0.6, 0.3],
                     "R": [1.0, 2.3, 2.1, 1.6, 1.3, 1.1, 0.9, 0.7, 0.5, 0.2]},
    ...
    def generate_learning_curve(
        ...
        phase_budgets = {
            ...
            "N100": {"C": [0.06, 0.28, 0.18, 0.14, 0.10, 0.08, 0.06, 0.04, 0.03, 0.03],
                     "RC": [0.07, 0.26, 0.16, 0.12, 0.10, 0.08, 0.06, 0.05, 0.04, 0.06],
                     "R": [0.09, 0.23, 0.15, 0.11, 0.09, 0.08, 0.06, 0.05, 0.04, 0.10]},
